...
class Motif {
  ...
  display() {
    ...
    let x0, y0, x1, y1, x2, y2, x3, y3, x4, y4, x5, y5, x6, y6, x7, y7, x8, y8; //Shape 1 vertices
    x0 = 0;
    y0 = 0;
    x1 = 0;
    y1 = this.a;
...
function setup() {
  ...
  dx = 2 * (a + d + e + f);
  dy = 2 * (a + d + e + f) * cos(30);
  doff = a + d + e + f; //approximate the nRow and nCol values
