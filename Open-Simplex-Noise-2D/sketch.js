  ...
  for (let y = 0; y < height; y++)
  {
    var xoff = 0;
     for(let x = 0; x < width; x++)
     {
       ...
       let value = openSimplex.noise3D(xoff/noiseScale,yoff/noiseScale,zoff/noiseScale);
       let bright = map(value,-1,1,0,255);
       //console.log(value);
...
// -------------------------------------------------------------------
// the library from https://github.com/blindman67/SimplexNoiseJS
// noise2D(x, y)
// noise3D(x, y, z)
// noise4D(x, y, z, w)

//  yes i should include it differently... 
